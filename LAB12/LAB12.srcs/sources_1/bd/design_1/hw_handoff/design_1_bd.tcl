...
proc create_root_design { parentCell } {
  ...
  set fft_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:fft:1.1 fft_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins fft_0/input_vector]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net fft_0_output_vector [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins fft_0/output_vector]
connect_bd_intf_net -intf_net [get_bd_intf_nets fft_0_output_vector] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets fft_0_output_vector]
