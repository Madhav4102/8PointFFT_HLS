...
HD_PWD='C:/Users/HP/Desktop/ELD_2024/LAB12/LAB12.runs/design_1_fft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fft_0_0.tcl
